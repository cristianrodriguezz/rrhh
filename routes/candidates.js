...
const { uploadCandidate, uploadCv, getCandidates, deleteCandidateById , updateCandidate, getCvByCandidateId, getExcelCandidates} = require('../controllers/candidates')
...
router.get('/get-excel',validateUserId, getExcelCandidates)
